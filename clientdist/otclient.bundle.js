	...
	var App = (function () {
	    ...
	    App.prototype.render = function () {
	        if (this.doNeedRender) {
	            ReactDOM.render(React.createElement(app_1.ReactApp, { name: this.UserName, url: this.Url, status: this.Status, captureElementCB: captureElementCB, contentChangeCB: contentChangeCB, nameChangeCB: nameChangeCB, newCB: newCB, submitChatCB: submitChatCB, chatCB: chatCB, isChatOn: this.isChatOn, nChatSeen: this.nChatSeen, clientID: this.clientID, chatArray: this.chatArray, users: this.usersValue }), document.getElementById("root"));
	            this.doNeedRender = false;
	        }
	    };
	    ...
	    App.prototype.newScratchPad = function () {
	        this.cancelEdits();
	        this.cancelCreate();
	        this.cancelJoin();
	        this.currentSession = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var navbar_1 = __webpack_require__(8);
	var username_1 = __webpack_require__(9);
	var scratchpad_1 = __webpack_require__(10);
	...
	var ReactApp = (function (_super) {
	    ...
	    ReactApp.prototype.render = function () {
	        ...
	        var cmpNav = React.createElement(navbar_1.NavBar, { url: this.props.url, name: this.props.name, nameChangeCB: this.props.nameChangeCB, newCB: this.props.newCB, chatCB: this.props.chatCB, isChatOn: this.props.isChatOn, nChatUnseen: nChatUnseen });
	        var cmpUser = React.createElement(username_1.UserName, { name: this.props.name, nameChangeCB: this.props.nameChangeCB }); // unused
	        var cmpScratch = React.createElement(scratchpad_1.ScratchPad, { captureElementCB: this.props.captureElementCB, contentChangeCB: this.props.contentChangeCB });
	        ...
	        if (this.props.isChatOn)
	            ...
	            return (React.createElement("div", { className: "wrapper" },
	                React.createElement("div", { className: "header" }, cmpNav),
	                React.createElement("div", { className: "content" }, cmpScratch),
	                React.createElement("div", { className: "footer" }, cmpMessage)));
	    };
	    return ReactApp;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserName = (function (_super) {
	    ...
	    UserName.prototype.handleChange = function (event) {
	        this.props.nameChangeCB(event.target.value);
	    };
	    UserName.prototype.render = function () {
	        return (React.createElement("div", { className: "headerrow" },
	            "Name:\u00A0 ",
	            React.createElement("input", { className: "line", type: "text", value: this.props.name, onChange: this.handleChange })));
	    };
	    return UserName;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	var React = __webpack_require__(5);
	var ScratchPad = (function (_super) {
	    __extends(ScratchPad, _super);
	    ...
	    ScratchPad.prototype.handleChange = function (event) {
	        var el = $('#scratchpad')[0];
	        this.props.contentChangeCB(event.target.value, el.selectionStart, el.selectionEnd);
	    };
	    ScratchPad.prototype.handleCaptureSelection = function (event) {
	        var el = $('#scratchpad')[0];
	        this.props.contentChangeCB(event.target.value, el.selectionStart, el.selectionEnd);
	    };
	    ScratchPad.prototype.render = function () {
	        var _this = this;
	        return (React.createElement("textarea", { id: 'scratchpad', ref: function (textarea) { return _this.props.captureElementCB(textarea); }, onChange: this.handleChange, onKeyUp: this.handleCaptureSelection, onMouseUp: this.handleCaptureSelection }));
	    };
	    return ScratchPad;
	}(React.Component));
...
/***/ }
/******/ ]);
//# sourceMappingURL=otclient.bundle.js.map